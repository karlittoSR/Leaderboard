...
1. **Instalar PowerShell 7**:
  ...
  - Escolha a **ultima release** (selo verde), **nao** preview
  - Baixe o instalador correto para seu sistema
  - **Windows**: use o `.msi` (x64 ou x86)
...
**Cancelar entrada**: Pressione **Esc** ao digitar texto  
